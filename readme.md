...
[^1]: interpreter path in vs code command pallette ./project/venv/bin/python3.9
...
[^1]: That will create a build folder in project directory and after compilation of pyteal code to teal files
